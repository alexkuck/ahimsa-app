...
public class OldNodeService extends Service {
...
//    public static final String ACTION_BROADCAST_TRANSACTION = OldNodeService.class.getPackage().getName() + ".broadcast_transaction";

    //OldNodeService--------------------------------------------
    private long serviceCreatedAt;
    private static final String TAG = "OldNodeService";
    ...
    public void onDestroy(){
        ...
        Toast.makeText(getApplicationContext(), "Disabled OldNodeService",
                Toast.LENGTH_SHORT).show();
    ...
    public class LocalBinder extends Binder{
        public OldNodeService getService() {
            return OldNodeService.this;
        }
    }
